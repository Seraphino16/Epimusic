...
const UserAddressBook = () => {
    ...
    useEffect(() => {
        const fetchAddresses = async () => {
            ...
            try {
                const response = await axios.get(`/api/user/${userId}/addresses`); //localhost
    ...
    const handleSetPrimary = async (id) => {
        ...
        try {
            await axios.patch(`/api/user/${userId}/addresses/${id}/set-primary`); //localhost
    ...
    const handleDeleteAddress = async (id) => {
        ...
        try {
            await axios.delete(`/api/user/${userId}/addresses/${id}`); //localhost
